...
class pagination{
    ...
    public function paginate(){
		...
		if($this->page_num > 1){$i_previous = '<li><a href="'.$this->page.''.$this->request.'=1"><i class="fa fa-angle-double-left"></i></a></li>';}
		if($this->page_num < $this->ortalama){$i_next = '<li><a href="'.$this->page.''.$this->request.'='.$this->ortalama.'"><i class="fa fa-angle-double-right"></i></a></li>';}
		if($this->page_num <= 1){$previous = '<li><a href="#" onclick="return false">'.$this->previous_text.'</a></li>';} else{$previous_a = $this->page_num-1; $previous = '<li><a href="'.$this->page.''.$this->request.'='.$previous_a.'">'.$this->previous_text.'</a></li>';}
		if($this->page_num == $this->ortalama){$next = '<li><a href="#" onclick="return false">'.$this->next_text.'</a></li>';} else{$next_a = $this->page_num+1; $next = '<li><a href="'.$this->page.''.$this->request.'='.$next_a.'">'.$this->next_text.'</a></li>';}
